...
import { type MeteorCardProps } from "@/components/dashboardPage/BlogPostCard/types";

export function MeteorCard({ title }: MeteorCardProps) {
	return (
		<div className="w-80">
			<div className="relative w-full max-w-xs">
				<div className="absolute inset-0 h-full w-full scale-[0.80] transform rounded-full bg-red-500 bg-gradient-to-r from-blue-500 to-teal-500 blur-3xl" />
				<div className="relative flex h-full flex-col items-start justify-end overflow-hidden rounded-2xl border border-gray-800 bg-midnight px-4 py-8 shadow-xl">
